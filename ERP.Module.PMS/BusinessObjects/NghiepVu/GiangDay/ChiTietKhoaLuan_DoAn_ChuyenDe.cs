...
{
    [ModelDefault("Caption", "Chi tiết khối lượng giảng dạy khóa luận - đồ án - chuyên đề")]
    public class ChiTietKhoaLuan_DoAn_ChuyenDe : BaseObject
    {
        #region key
        ...
        public ChiTietKhoaLuan_DoAn_ChuyenDe(Session session) : base(session) { }
