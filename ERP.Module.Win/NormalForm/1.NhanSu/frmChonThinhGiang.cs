...
namespace ERP.Module.Win.NormalForm.NhanSu
{
    public partial class frmChonThinhGiang : XtraForm
    {
        ...
        private XPCollection<GiangVienThinhGiang> _nhanVienList;
        private XPCollection<ChiTietTimKiemThinhGiang> _trichDanhSachNhanVienList;
        private GiangVienThinhGiang _thongTinThinhGiang;
        ...
        private void frmChonThinhGiang_Load(object sender, EventArgs e)
        {
        ...
        private void nhanVienTreeList_BeforeExpand(object sender, DevExpress.XtraTreeList.BeforeExpandEventArgs e)
        {
            ...
            {
                e.Node.Nodes.Clear();
                XPCollection<GiangVienThinhGiang> nhanVienList = new XPCollection<GiangVienThinhGiang>(_session, CriteriaOperator.Parse("BoPhan=?", ((BoPhan)e.Node.Tag).Oid));
        ...
        private void AddNhanVien(TreeListNode parent, XPCollection<GiangVienThinhGiang> nvList)
        {
            nhanVienTreeList.BeginUnboundLoad();
            //
        ...
        public XPCollection<ChiTietTimKiemThinhGiang> GetStaffList()
        {
            _trichDanhSachNhanVienList = new XPCollection<ChiTietTimKiemThinhGiang>(_session, false);
            //
        ...
        private void FindStaffByDepartmentNodes(TreeListNodes nodes)
        {
            foreach (TreeListNode node in nodes)
            {
                ...
                {
                    _thongTinThinhGiang = _session.GetObjectByKey<GiangVienThinhGiang>(((GiangVienThinhGiang)node.Tag).Oid);
                    if (_thongTinThinhGiang != null)
                    {
                        ChiTietTimKiemThinhGiang chiTiet = new ChiTietTimKiemThinhGiang(_session);
                        chiTiet.ThinhGiang = _thongTinThinhGiang;
