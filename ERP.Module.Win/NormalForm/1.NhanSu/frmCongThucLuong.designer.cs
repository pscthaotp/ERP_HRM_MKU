...
{
    partial class frmCongThucLuong
    {
        /// <summary>
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(frmCongThucLuong));
            ...
            this.Load += new EventHandler(this.frmCongThucLuong_Load);
