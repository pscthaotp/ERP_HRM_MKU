...
namespace ERP.Module.Win.NormalForm.NhanSu
{
    partial class frmChonThinhGiang
    {
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(frmChonThinhGiang));
            ...
            this.miCheckAll.Text = "Chọn tất cả giảng viên thỉnh giảng";
            ...
            this.miCheckSelected.Text = "Chọn những giảng viên được đánh dấu";
            ...
            this.miUncheckAll.Text = "Bỏ chọn tất cả giảng viên";
            ...
            this.miUncheckSelected.Text = "Bỏ chọn những giảng viên được đánh dấu";
            ...
            this.Load += new EventHandler(this.frmChonThinhGiang_Load);
