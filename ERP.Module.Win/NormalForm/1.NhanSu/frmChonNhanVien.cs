...
{
    public partial class frmChonNhanVien : XtraForm
    {
        ...
        private XPCollection<ChiTietDangKyDaoTao> _dangKyDaoTaoList;
        ...
        public frmChonNhanVien(Session session, BoPhan boPhan)
        {
            InitializeComponent();
        ...
        private void frmChonCanBo_Load(object sender, EventArgs e)
        {
            ...
            {
                _boPhanDuocPhanQuyenList = new XPCollection<BoPhan>(_session, new InOperator("Oid", Common.Department_GetChildDepartmentList_ByCompany(_boPhan)));
            }

            //
            AddDataNodeOfTreeList(_boPhan.Oid);
        }
        ...
        //lấy danh sách nhân viên đăng ký đào tạo
        public XPCollection<ThongTinNhanVien> GetNhanVienListList()
        {
