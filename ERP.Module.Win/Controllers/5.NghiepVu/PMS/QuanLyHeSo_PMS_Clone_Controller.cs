...
{
    public partial class QuanLyHeSo_PMS_Clone_Controller : ViewController
    {
        IObjectSpace _obs = null;
        QuanLyHeSo clone;
        CollectionSource collectionSource;
        ThongTinClone _source;
        public QuanLyHeSo_PMS_Clone_Controller()
        {
            InitializeComponent();
        ...
        {
            clone = View.CurrentObject as QuanLyHeSo;
            if (clone != null)
            {
                ...
                object kq = DataProvider.GetValueFromDatabase("spd_PMS_Clone_QuanLyHeSo", CommandType.StoredProcedure, pDongBo);
                if (kq != null)
