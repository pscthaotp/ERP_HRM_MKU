...
{
    public partial class ThongKeBienDongSoLuongNhanSuController : ThongKeBaseController
    {
        //        
        ...
        //
        public ThongKeBienDongSoLuongNhanSuController(XafApplication app)
        {
            InitializeComponent();                      
        }

        private void ThongKeBienDongSoLuongNhanSuController_Load(object sender, EventArgs e)
        {            
            ...
            //
            DataTable dataList = DataProvider.GetDataTable("spd_ThongKe_ThongKeBienDongSoLuongNhanSu", CommandType.StoredProcedure, param);
            //
            chart_Column.DataSource = dataList;
            chart_Circle.DataSource = dataList;
            //              
            chartTitle1.Text = String.Concat("Biến động số lượng nhân sự qua ba năm");
            chartTitle2.Text = String.Concat("Tỷ trọng số lượng nhân sự trong năm ", DateTime.Now.Year.ToString());
        ...
        public override void LoadData(Guid congTy, DateTime tinhDenNgay, bool laQuanTri)
        {
            ...
            //                      
            chartTitle1.Text = String.Concat("Biến động số lượng nhân sự qua ba năm");         
            chartTitle2.Text = String.Concat("Tỷ trọng số lượng nhân sự trong năm ", tinhDenNgay.Year.ToString());
        ...
        private void OnBoundDataChanged(object sender, EventArgs args)
        {
            ...
            {
                chart_Column.Series[0].Name = String.Concat("Số lượng NS ", namThuNhat.ToString());
                chart_Column.Series[1].Name = String.Concat("Số lượng NS ", namThuHai.ToString());
                chart_Column.Series[2].Name = String.Concat("Số lượng NS ", namThuBa.ToString());
            }
        }
    }
}
