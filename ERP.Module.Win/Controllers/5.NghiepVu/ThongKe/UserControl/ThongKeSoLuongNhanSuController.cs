...
{
    public partial class ThongKeSoLuongNhanSuController : ThongKeBaseController
    {
        //        
        private string quyen = Common.System_GetDeparment_Role_ByUser();        
        //
        public ThongKeSoLuongNhanSuController(XafApplication app)
        {
            InitializeComponent();           
        }
        ...
        {            
            ...
            //
            DataTable dataList = DataProvider.GetDataTable("spd_ThongKe_SoLuongNhanSu", CommandType.StoredProcedure, param);
            //
            chart_Column.DataSource = dataList;
            chart_Circle.DataSource = dataList;
            //           
            chartTitle1.Text = chartTitle2.Text = String.Concat("Số lượng nhân sự năm ", (DateTime.Now.Year - 1).ToString());            
        }
        ...
        public override void LoadData(Guid congTy, DateTime tinhDenNgay, bool laQuanTri)
        {
            ...
            chart_Circle.DataSource = dataList;           
            //            
            chartTitle1.Text = chartTitle2.Text = String.Concat("Số lượng nhân sự năm ", (tinhDenNgay.Year).ToString()); ;   
        }
