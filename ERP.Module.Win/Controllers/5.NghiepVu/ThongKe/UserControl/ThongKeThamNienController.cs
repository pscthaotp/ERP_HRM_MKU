...
{
    public partial class ThongKeThamNienController : ThongKeBaseController
    {
        private string quyen = Common.System_GetDeparment_Role_ByUser();  
        //
        public ThongKeThamNienController(XafApplication app)
        {
            InitializeComponent();
        }

        private void ThongKeThamNienController_Load(object sender, EventArgs e)
        {
            ...
            //
            DataTable dataList = DataProvider.GetDataTable("spd_ThongKe_ThongKeThamNien", CommandType.StoredProcedure,param);
            //
            chart_Column.DataSource = dataList;
            chart_Circle.DataSource = dataList;
            //
            chartTitle1.Text = chartTitle2.Text = String.Concat("Thống kê nhân sự theo thâm niên năm ", (DateTime.Now.Year - 1).ToString());       
        }
        ...
        public override void LoadData(Guid congTy, DateTime tinhDenNgay, bool laQuanTri)
        {
            ...
            chart_Circle.DataSource = dataList;
            //            
            chartTitle1.Text = chartTitle2.Text = String.Concat("Thống kê nhân sự theo thâm niên năm ", (tinhDenNgay.Year).ToString()); ;
        }
