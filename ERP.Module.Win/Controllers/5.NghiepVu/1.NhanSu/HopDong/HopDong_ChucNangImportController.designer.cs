...
{
    partial class HopDong_ChucNangImportController
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.singleChoiceActionList.Id = "HopDong_ChucNangImportController";
            ...
            this.singleChoiceActionList.TargetViewType = DevExpress.ExpressApp.ViewType.DetailView;
            this.singleChoiceActionList.TargetObjectType = typeof(QuanLyHopDong);
            this.singleChoiceActionList.ToolTip = null;
            this.singleChoiceActionList.TypeOfView = typeof(DevExpress.ExpressApp.DetailView);
            ...
            // 
            // Con_DifferentFunctionController
            // 
            this.Actions.Add(this.singleChoiceActionList);
            this.ViewControlsCreated += new EventHandler(this.HopDong_ChucNangImportController_ViewControlsCreated);
