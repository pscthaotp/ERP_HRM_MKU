...
{
    public partial class QuyetDinh_ImportNangLuongController : ViewController
    {
        private IObjectSpace _obs;
        private QuyetDinh_ChonNguoiKy _chonNguoiKy;

        public QuyetDinh_ImportNangLuongController()
        {
            InitializeComponent();
        ...
        private void popupWindowShowAction1_Execute(object sender, PopupWindowShowActionExecuteEventArgs e)
        {
            ...
            {
                Imp_QuyetDinhNangLuong.ImportQuyetDinhNangLuong(View.ObjectSpace,_chonNguoiKy);
            }
            //
        ...
        //
        private void QuyetDinh_ImportNangLuongController_Activated(object sender, EventArgs e)
        {
            popupWindowShowAction1.Active["TruyCap"] = Common.IsWriteGranted<QuyetDinhNangLuong>();
        }
    }
}
