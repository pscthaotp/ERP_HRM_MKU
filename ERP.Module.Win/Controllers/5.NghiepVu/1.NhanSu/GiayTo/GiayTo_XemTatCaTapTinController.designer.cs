...
{
    partial class GiayTo_XemTatCaTapTinController
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.simpleAction1.Id = "GiayTo_XemTatCaTapTinController";
            this.simpleAction1.ImageName = "BO_Download";
            ...
            this.simpleAction1.ToolTip = "Tải tất cả tập tin.";
            this.simpleAction1.TypeOfView = typeof(DevExpress.ExpressApp.ListView);
            this.simpleAction1.Execute += new DevExpress.ExpressApp.Actions.SimpleActionExecuteEventHandler(this.simpleAction1_Execute);
            // 
            // Profile_DownloadAllController
            // 
            this.Activated += new EventHandler(this.GiayTo_XemTatCaTapTinController_Activated);
