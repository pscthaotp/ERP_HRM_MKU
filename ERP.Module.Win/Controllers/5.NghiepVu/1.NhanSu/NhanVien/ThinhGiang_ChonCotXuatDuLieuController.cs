...
{
    public partial class ThinhGiang_ChonCotXuatDuLieuController : ViewController
    {
        public ThinhGiang_ChonCotXuatDuLieuController()
        {
            InitializeComponent();
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (gridControl != null)
            {
                ...
                if (gridView != null)
                {
                    using (frmListViewColumns dialog = new frmListViewColumns(typeof(ChiTietTimKiemThinhGiang)))
                    {
