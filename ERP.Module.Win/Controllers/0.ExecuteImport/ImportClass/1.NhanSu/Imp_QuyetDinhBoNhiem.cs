...
{
    public class Imp_QuyetDinhBoNhiem
    {
                                    ...
                                    foreach (DataRow item in dt.Rows)
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(maQuanLyText))
                                        {
                                            ...
                                            if (nhanVien != null)
                                            {
                                                ...
                                                quyetDinhBoNhiem.PhanLoaiNguoiKy = uow.GetObjectByKey<PhanLoaiNguoiKy>(obj.PhanLoaiNguoiKy.Oid);
                                                quyetDinhBoNhiem.ChucVuNguoiKy = uow.GetObjectByKey<ChucVuNguoiKy>(obj.ChucVuNguoiKy.Oid);
                                                quyetDinhBoNhiem.NguoiKy = uow.GetObjectByKey<ThongTinNhanVien>(obj.NguoiKy.Oid);
                                                quyetDinhBoNhiem.CongTy = uow.GetObjectByKey<CongTy>(obj.CongTy.Oid);
                                                ...
                                                if (!string.IsNullOrEmpty(maQuanLyText))
                                                {
                                                    ...
                                                    quyetDinhBoNhiem.BoPhanMoi = nhanVien.BoPhan;
                                                    quyetDinhBoNhiem.ChucVuCu = nhanVien.ChucVu;
                                                    quyetDinhBoNhiem.ChucDanhCu = nhanVien.ChucDanh;
                                                    quyetDinhBoNhiem.NgayBNChucVuCu = nhanVien.NgayBoNhiemChucVu;
                                                }
                                                #endregion
                                                ...
                                                if (!string.IsNullOrEmpty(chucDanhMoiText))
                                                {
                                                    ...
                                                    if (chucDanh != null)
                                                        quyetDinhBoNhiem.ChucDanhMoi = chucDanh;
                                                    else
