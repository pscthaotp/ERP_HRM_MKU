...
{
    public partial class BoNhiem_ImportQuyetDinhTaiBoNhiemController : ViewController
    {
        private IObjectSpace _obs;
        private QuyetDinh_ChonNguoiKy _chonNguoiKy;

        public BoNhiem_ImportQuyetDinhTaiBoNhiemController()
        {
            InitializeComponent();
        ...
        private void popupWindowShowAction1_Execute(object sender, PopupWindowShowActionExecuteEventArgs e)
        {
            ...
            {
                Imp_QuyetDinhTaiBoNhiem.XuLy(View.ObjectSpace, _chonNguoiKy);
            }
            //
        ...
        //
        private void BoNhiem_ImportQuyetDinhTaiBoNhiemController_Activated(object sender, EventArgs e)
        {
            popupWindowShowAction1.Active["TruyCap"] = Common.IsWriteGranted<QuyetDinhTaiBoNhiem>();
        }
    }
}
