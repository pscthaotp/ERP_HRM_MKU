...
{
    public partial class ChamCong_ImportChamCongController : ViewController
    {
        private IObjectSpace _obs;
        private OfficeBaseObject _chonLoaiOffice;
        private CC_QuanLyChamCong _quanLyChamCong;

        public ChamCong_ImportChamCongController()
        {
            InitializeComponent();
        ...
        private void popupWindowShowAction1_CustomizePopupWindowParams(object sender, CustomizePopupWindowParamsEventArgs e)
        {
            ...
            //
            _quanLyChamCong = View.CurrentObject as CC_QuanLyChamCong;
        ...
        private void popupWindowShowAction1_Execute(object sender, PopupWindowShowActionExecuteEventArgs e)
        {
            ...
            {
                //Xử lý
                Imp_ChamCong.ImportChamCong(((XPObjectSpace)View.ObjectSpace), _chonLoaiOffice,_quanLyChamCong.Oid);
                //
        ...
        {
            popupWindowShowAction1.Active["TruyCap"] = Common.IsWriteGranted<CC_QuanLyChamCong>();
        }
    }
}
