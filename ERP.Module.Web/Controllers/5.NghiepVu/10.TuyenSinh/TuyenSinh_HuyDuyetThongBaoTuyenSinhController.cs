...
{
    public partial class TuyenSinh_HuyDuyetThongBaoTuyenSinhController : ViewController<DetailView>
    {
        public TuyenSinh_HuyDuyetThongBaoTuyenSinhController()
        {
            InitializeComponent();
        ...
        {
            //
            ThongBaoTuyenSinh obj = View.CurrentObject as ThongBaoTuyenSinh;
        ...
        private void TuyenSinh_HuyDuyetThongBaoTuyenSinhController_Activated(object sender, EventArgs e)
        {
