...
{
    public partial class TuyenSinh_DienThoaiTuVanTuyenSinhController : ViewController<DetailView>
    {
        public TuyenSinh_DienThoaiTuVanTuyenSinhController()
        {
            InitializeComponent();
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            {
                if (obj.HinhThuc != Enum.TuyenSinh.HinhThucTuVanEnum.DienThoai)
                {
                    WebWindow.CurrentRequestWindow.RegisterStartupScript("", "alert('Chọn hình thức Điện thoại!!!')");
                    return;
                }
                        ...
                        foreach (var item in khachHangList)
                        {
                            ...
                            if (khachHang != null)
                            {
                                ...
                                if (chiTiet == null)
                                {
                                    ...
                                    chiTiet.HinhThucTuVan = Enum.TuyenSinh.HinhThucTuVanEnum.DienThoai;
        ...
        private void TuyenSinh_DienThoaiTuVanTuyenSinhController_Activated(object sender, EventArgs e)
        {
