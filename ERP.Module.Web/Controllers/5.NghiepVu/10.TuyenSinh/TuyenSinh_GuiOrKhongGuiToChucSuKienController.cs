...
{
    public partial class TuyenSinh_GuiOrKhongGuiToChucSuKienController : ViewController<ListView>
    {
        public TuyenSinh_GuiOrKhongGuiToChucSuKienController()
        {
            InitializeComponent();
        ...
        private void simpleAction1_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            foreach (var item in chiTietList)
            {
                ...
                if (chiTiet != null)
                {
                    ...
                    {
                        if (chiTiet.DaGuiLoiMoi)
                            chiTiet.DaGuiLoiMoi = false;
                        else
                        {
                            chiTiet.DaGuiLoiMoi = true;
                        }
                    }
                    //
                    daChinhSua = true;
        ...
        private void TuyenSinh_GuiOrKhongGuiToChucSuKienController_Activated(object sender, EventArgs e)
        {
            //
