...
namespace ERP.Module.NghiepVu.NhanSu.NhanViens
{
    ...
    public class TimKiemNhanVien : BaseObject,ICongTy
    {
        ...
        public XPCollection<ChiTietTimKiemNhanVien> ListChiTietTimKiemNhanVien { get; set; }
        ...
        public override void AfterConstruction()
        {
            ...
            //
            ListChiTietTimKiemNhanVien = new XPCollection<ChiTietTimKiemNhanVien>(Session, false);
            //
