...
namespace ERP.Module.Report.NhanSu.ChamCong
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo: Bảng tổng hợp ngày phép")]
    [Appearance("BaoCao_ChamCong_TongHopNgayPhep.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_ChamCong_BangTongHopNgayPhep : StoreProcedureReport
    {
        ...
        public Report_ChamCong_BangTongHopNgayPhep(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Rpt_ChamCong_BangTongHopNgayPhep");
