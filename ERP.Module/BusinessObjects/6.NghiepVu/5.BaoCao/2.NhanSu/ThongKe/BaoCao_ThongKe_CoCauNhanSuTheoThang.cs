...
{
    [NonPersistent]
    [ModelDefault("Caption", "Cơ cấu nhân sự theo tháng - Nhân sự")]
    [Appearance("Report_DanhSach_NhanVienTheoPhongBan.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class BaoCao_ThongKe_CoCauNhanSuTheoThang : StoreProcedureReport
    {
        ...
        public BaoCao_ThongKe_CoCauNhanSuTheoThang(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_rpt_ThongKe_CoCauNhanSuTheoThang");
