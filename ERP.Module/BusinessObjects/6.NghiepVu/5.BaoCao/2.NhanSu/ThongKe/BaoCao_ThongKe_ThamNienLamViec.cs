...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo thâm niên làm việc - Nhân sự")]
    [Appearance("BaoCao_DanhSach_ThamNienLamViec.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class BaoCao_ThongKe_ThamNienLamViec : StoreProcedureReport
    {
        ...
        public BaoCao_ThongKe_ThamNienLamViec(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Rpt_ThongKe_ThamNienLamViec");
