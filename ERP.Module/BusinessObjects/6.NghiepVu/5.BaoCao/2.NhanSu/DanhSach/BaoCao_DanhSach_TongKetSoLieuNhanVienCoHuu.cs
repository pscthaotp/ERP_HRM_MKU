...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo :Danh sách tổng kết số liệu nhân viên cơ hữu")]
    [Appearance("BaoCao_DanhSach_BoNhiemNhanSu.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class BaoCao_DanhSach_TongKetSoLieuNhanVienCoHuu : StoreProcedureReport
    {
        ...
        public BaoCao_DanhSach_TongKetSoLieuNhanVienCoHuu(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Rpt_DanhSach_TongKetSoLieuNhanVienCoHuu");
