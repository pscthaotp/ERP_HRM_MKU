...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo hợp đồng, quyết định không hợp lệ - Nhân sự")]
    [Appearance("BaoCao_DanhSach_HopDongQuyetDinhKhongHopLe.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class BaoCao_DanhSach_HopDongQuyetDinhKhongHopLe : StoreProcedureReport
    {
        ...
        public BaoCao_DanhSach_HopDongQuyetDinhKhongHopLe(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Rpt_DanhSach_HopDongQuyetDinhKhongHopLe");
