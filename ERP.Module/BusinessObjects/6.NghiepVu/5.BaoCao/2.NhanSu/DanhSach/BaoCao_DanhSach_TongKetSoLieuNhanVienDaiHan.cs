...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo :Danh sách tổng kết số liệu nhân viên dài hạn")]
    [Appearance("BaoCao_DanhSach_BoNhiemNhanSu.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class BaoCao_DanhSach_TongKetSoLieuNhanVienDaiHan : StoreProcedureReport
    {
        ...
        public BaoCao_DanhSach_TongKetSoLieuNhanVienDaiHan(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Rpt_DanhSach_TongKetSoLieuNhanVienDaiHan");
