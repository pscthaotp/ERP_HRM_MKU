...
{
    [NonPersistent]
    [ModelDefault("Caption", "Bảng tổng hợp thanh toán tiền lương - Tiền lương")]
    [Appearance("BangThanhToanTienLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCa")]
    public class BaoCao_Luong_BangTongHopThanhToanTienLuong : StoreProcedureReport
    {
        private KyTinhLuong _KyTinhLuong;
        private BoPhan _BoPhan;
        private bool _TatCa = true;
        private CongTy _CongTy;
        private string _BoPhanPhanQuyen;
        //
        [ImmediatePostData]
        ...
        //Dùng để xuất báo cáo ra workbook
        [Browsable(false)]
        public string BoPhanPhanQuyen
        {
            get
            {
                return _BoPhanPhanQuyen;
            }
            set
            {
                SetPropertyValue("BoPhanPhanQuyen", ref _BoPhanPhanQuyen, value);
            }
        }

        public BaoCao_Luong_BangTongHopThanhToanTienLuong(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = new SqlCommand("spd_Rpt_Luong_BangTongHopThanhToanTienLuong");
