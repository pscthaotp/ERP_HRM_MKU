...
{
    [NonPersistent]
    [ModelDefault("Caption", "Bảng thanh toán thu nhập tăng thêm")]
    public class BaoCao_Luong_BangThanhToanThuNhapTangThem : StoreProcedureReport
    {
        ...
        public BaoCao_Luong_BangThanhToanThuNhapTangThem(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = new SqlCommand("spd_Rpt_Luong_BangThanhToanThuNhapTangThem");
