...
{
    [NonPersistent]
    [ModelDefault("Caption", "Bảng thanh toán tiền lương - Tiền lương")]
    [Appearance("BangThanhToanTienLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCa")]
    public class BaoCao_Luong_BangThanhToanTienLuong : StoreProcedureReport
    {
        ...
        public BaoCao_Luong_BangThanhToanTienLuong(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = new SqlCommand("spd_Rpt_Luong_BangThanhToanTienLuong");
