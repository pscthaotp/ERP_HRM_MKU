...
namespace ERP.Module.Report.TienLuong.TLU.LuongThang13
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng lương tháng 13 tiền mặt tổng hợp ( theo bộ phận)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangLuongThang13TienMatTongHop_TheoBoPhan : StoreProcedureReport
    {
       ...
       // private NganHang _NganHang;
        ...
        public Report_Luong_BangLuongThang13TienMatTongHop_TheoBoPhan(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_BangLuongThang13TienMatTongHop_TheoBoPhan");
