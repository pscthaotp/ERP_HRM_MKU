...
namespace ERP.Module.Report.TienLuong.TLU.LuongThang13
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng kết xuất lương tháng 13 HĐQT-HĐT ( chuyển khoản) chữ hoa")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_KietXuatLuongThang13_HDQT_CK_ChuHoa : StoreProcedureReport
    {
        ...
        public Report_Luong_KietXuatLuongThang13_HDQT_CK_ChuHoa(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_BangKietXuatLuongThang13ChuyenKhoanChuHoa_HDQT");
