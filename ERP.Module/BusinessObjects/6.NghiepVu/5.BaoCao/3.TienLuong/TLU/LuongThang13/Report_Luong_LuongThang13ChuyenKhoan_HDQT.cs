...
namespace ERP.Module.Report.TienLuong.TLU.LuongThang13
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng lương tháng 13 HĐQT - HĐT chuyển khoản")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_LuongThang13ChuyenKhoan_HDQT : StoreProcedureReport
    {
        ...
        public Report_Luong_LuongThang13ChuyenKhoan_HDQT(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_LuongThang13ChuyenKhoan_HDQT");
