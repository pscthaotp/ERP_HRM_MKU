...
namespace ERP.Module.Report.TienLuong.TLU.LuongThang13
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng lương tháng 13 tiền mặt chi tiết ( theo bộ phận)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_BangLuongThang13TienMatChiTiet_TheoBoPhan : StoreProcedureReport
    {
        ...
        public Report_Luong_BangLuongThang13TienMatChiTiet_TheoBoPhan(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_BangLuongThang13TienMatChiTiet_TheoBoPhan");
