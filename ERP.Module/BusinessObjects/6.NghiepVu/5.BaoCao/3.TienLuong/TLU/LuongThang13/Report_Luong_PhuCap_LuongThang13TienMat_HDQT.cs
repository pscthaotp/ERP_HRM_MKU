...
namespace ERP.Module.Report.TienLuong.TLU.LuongThang13
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo: Bảng lương phụ cấp tháng 13 HĐQT,HĐT tiền mặt")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_PhuCap_LuongThang13TienMat_HDQT : StoreProcedureReport
    {
        ...
        public Report_Luong_PhuCap_LuongThang13TienMat_HDQT(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_PhuCap_LuongThang13TienMat_HDQT");
