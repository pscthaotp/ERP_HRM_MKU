...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng tổng hợp phụ cấp tiền mặt (phòng ban, bộ phận)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_PhuCap_TongHopPhuCapPhongBan : StoreProcedureReport
    {
        ...
        public Report_PhuCap_TongHopPhuCapPhongBan(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_PhuCap_TongHopPhuCapCuaPhongBan");
