...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng tổng hợp lương tháng tiền mặt( phòng ban , bộ môn)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_TongHopLuongPhongBan_BoMon : StoreProcedureReport
    {
        ...
        public Report_Luong_TongHopLuongPhongBan_BoMon(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_TongHopLuongCuaPhongBan_BoMon");
