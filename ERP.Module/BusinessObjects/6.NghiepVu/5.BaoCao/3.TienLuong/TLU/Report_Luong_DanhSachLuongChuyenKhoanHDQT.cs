...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Danh sách lương chuyển khoản HDQT")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_DanhSachLuongChuyenKhoanHDQT : StoreProcedureReport
    {
        ...
        [ModelDefault("Caption", "Loại form")]
        public LoaiChuHoaHayChuThuong LoaiChuHoaHayChuThuong
        {
            get;
            set;
        }

        public Report_Luong_DanhSachLuongChuyenKhoanHDQT(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_ChungTu_DanhSachPhuCapChuyenKhoan");
            ...
            if (LoaiChuHoaHayChuThuong == LoaiChuHoaHayChuThuong.ChuHoa)
            {
                FormChu = "ChuHoa";
            }
            if (LoaiChuHoaHayChuThuong == LoaiChuHoaHayChuThuong.ChuThuong)
            {
                FormChu = "ChuThuong";
            }
            cmd.Parameters.AddWithValue("@ChuThuong", FormChu);
            cmd.Parameters.AddWithValue("@LoaiNhanVien", "NhanVienBinhThuong");
            return cmd;
        }
