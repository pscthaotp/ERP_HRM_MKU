...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng phụ cấp tiền mặt HĐQT")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_PhuCap_HoiDongQuanTriTienMat : StoreProcedureReport
    {
        ...
        public Report_Luong_PhuCap_HoiDongQuanTriTienMat(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_PhuCap_HoiDongQuanTriTienMat");
