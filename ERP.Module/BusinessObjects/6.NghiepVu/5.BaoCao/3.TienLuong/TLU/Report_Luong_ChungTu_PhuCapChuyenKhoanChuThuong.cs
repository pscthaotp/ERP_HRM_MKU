...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng kết xuất phụ cấp chuyển khoảng chữ thường")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_ChungTu_PhuCapChuyenKhoanChuThuong : StoreProcedureReport
    {
        ...
        public Report_Luong_ChungTu_PhuCapChuyenKhoanChuThuong(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_ChungTu_BangKetXuatPhuCapChuyenKhoanChuThuong");
