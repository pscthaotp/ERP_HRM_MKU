...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng phụ cấp tháng chuyển khoản")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_PhuCap_DanhSachNhanVienPhongBan_ChiTiet : StoreProcedureReport
    {
        ...
        public Report_Luong_PhuCap_DanhSachNhanVienPhongBan_ChiTiet(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_PhuCap_DanhSachNhanVienPhongBan_ChiTiet");
