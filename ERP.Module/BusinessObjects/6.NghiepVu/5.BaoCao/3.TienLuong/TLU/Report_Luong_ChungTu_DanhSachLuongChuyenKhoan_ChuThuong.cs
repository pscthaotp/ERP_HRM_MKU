...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng kết xuất lương chuyển khoản ( chữ thường)")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_ChungTu_DanhSachLuongChuyenKhoan_ChuThuong : StoreProcedureReport
    {
        ...
        public Report_Luong_ChungTu_DanhSachLuongChuyenKhoan_ChuThuong(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_ChungTu_DanhSachLuongChuyenKhoan");
