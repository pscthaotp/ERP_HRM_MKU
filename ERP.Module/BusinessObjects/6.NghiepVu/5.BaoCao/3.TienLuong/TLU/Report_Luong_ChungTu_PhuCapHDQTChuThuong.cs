...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng kết xuất phụ cấp HĐQT chữ thường")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_ChungTu_PhuCapHDQTChuThuong : StoreProcedureReport
    {
        ...
        public Report_Luong_ChungTu_PhuCapHDQTChuThuong(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_ChungTu_BangKetXuatPhuCapHDQTChuThuong");
