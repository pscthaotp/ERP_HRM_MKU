...
namespace ERP.Module.Report.TienLuong.TLU
{
    [NonPersistent]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Báo cáo : Bảng lương tháng chuyển khoản ")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class Report_Luong_ChungTu_PhuCapChuyenKhoanChuThuongVaChuHoa_ChiTiet : StoreProcedureReport
    {
        ...
        public Report_Luong_ChungTu_PhuCapChuyenKhoanChuThuongVaChuHoa_ChiTiet(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Report_Luong_ChungTu_BangLuongThangChuyenKhoan");
