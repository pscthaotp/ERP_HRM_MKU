...
{
    [NonPersistent]
    [ModelDefault("Caption", "Bảng trích nộp bảo hiểm - Tiền lương")]
    public class BaoCao_Luong_BangTrichNopBaoHiem : StoreProcedureReport
    {
        ...
        public BaoCao_Luong_BangTrichNopBaoHiem(Session session) : base(session) { }
        ...
        {
            //
            SqlCommand cmd = new SqlCommand("spd_Rpt_Luong_BangTrichNopBaoHiem");
