...
{
    [NonPersistent]
    [ModelDefault("Caption", "Bảng thanh toán lương khoán - tiền lương")]
    public class BaoCao_Luong_BangThanhToanTienLuongKhoan: StoreProcedureReport
    {
        ...
        public BaoCao_Luong_BangThanhToanTienLuongKhoan(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = new SqlCommand("spd_Rpt_Luong_BangThanhToanTienLuongKhoan");
