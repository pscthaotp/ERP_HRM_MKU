...
{
    [NonPersistent]
    [ModelDefault("Caption", "Bảng trích nộp công đoàn - Tiền lương")]
    public class BaoCao_Luong_BangTrichNopCongDoan : StoreProcedureReport
    {
        ...
        public BaoCao_Luong_BangTrichNopCongDoan(Session session) : base(session) { }
        ...
        {
            //
            SqlCommand cmd = new SqlCommand("spd_Rpt_Luong_BangTrichNopCongDoan");
