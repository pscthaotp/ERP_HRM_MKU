...
{
    [NonPersistent]
    [ModelDefault("Caption", "Bảng chuyển khoản thu nhập tăng thêm - thu nhập tăng thêm")]
    [Appearance("BangLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCa")]
    public class BaoCao_ChungTu_BangChuyenKhoanThuNhapTangThem : StoreProcedureReport
    {
        ...
        public BaoCao_ChungTu_BangChuyenKhoanThuNhapTangThem(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Rpt_ChungTu_BangChuyenKhoanThuNhapTangThem");
