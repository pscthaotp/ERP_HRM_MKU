...
namespace ERP.Module.NghiepVu.TienLuong.TruyLuong
{
    ...
    [Appearance("BangTruyLinh.KhoaSo", TargetItems = "*", Enabled = false,Criteria = "KyTinhLuong.KhoaSo or ChungTu is not null")]
    [RuleCombinationOfPropertiesIsUnique("BangTruyLinh.Unique", DefaultContexts.Save, "KyTinhLuong;CongTy")]
    public class BangTruyLinh : BaseObject, ICongTy
    {
        ...
        [Aggregated]
        [ModelDefault("Caption", "Danh sách truy lĩnh")]
        [Association("BangTruyLinh-ListTruyLinhNhanVien")]
        public XPCollection<TruyLinhNhanVien> ListTruyLinhNhanVien
        {
            get
            {
                return GetCollection<TruyLinhNhanVien>("ListTruyLinhNhanVien");
            }
        }
        ...
        public BangTruyLinh(Session session) : base(session) { }
