...
{
    [NonPersistent]
    [ModelDefault("Caption", "Bảng chi tiết thu nhập khác cộng vào lương - Tiền lương")]
    [Appearance("BangThanhToanTienLuong.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCa")]
    public class BaoCao_Luong_BangChiTietThuNhapKhac : StoreProcedureReport
    {
        ...
        public BaoCao_Luong_BangChiTietThuNhapKhac(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = new SqlCommand("spd_Rpt_Luong_BangChiTietThuNhapKhac");
