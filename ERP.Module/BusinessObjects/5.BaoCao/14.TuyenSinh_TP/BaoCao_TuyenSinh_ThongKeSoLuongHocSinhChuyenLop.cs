...
{
    [NonPersistent]
    [ModelDefault("Caption", "Thống kê số lượng học sinh chuyển lớp - Tân phú")]
    ...
    public class BaoCao_TuyenSinh_ThongKeSoLuongHocSinhChuyenLop : StoreProcedureReport
    {
        //
        ...
        public BaoCao_TuyenSinh_ThongKeSoLuongHocSinhChuyenLop(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = DataProvider.GetCommand("spd_Rpt_TuyenSinh_TP_ThongKeSoLuongHocSinhChuyenLop", CommandType.StoredProcedure, param);
            //
            return cmd;
        }
