...
namespace ERP.Module.Report.BepAn
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Bếp ăn - Kết quả dinh dưỡng - Đề nghị mua hàng")]
    [Appearance("Enabled_SoLuong", TargetItems = "SoLuong", Enabled = false, Criteria = "LoaiChotSuatAn <> 0")]
    public class Report_BepAn_KhoBep_DeNghiMuaHang_KetQuaDinhDuong : StoreProcedureReport
    {
        ...
        public Report_BepAn_KhoBep_DeNghiMuaHang_KetQuaDinhDuong(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            parameter[11] = new SqlParameter("@Bep_DeNghiMuaHang", Bep_DeNghiMuaHang != null ? Bep_DeNghiMuaHang.Oid : Guid.Empty);
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_KhoBep_DeNghiMuaHang_KetQuaDinhDuong", System.Data.CommandType.StoredProcedure, parameter);
