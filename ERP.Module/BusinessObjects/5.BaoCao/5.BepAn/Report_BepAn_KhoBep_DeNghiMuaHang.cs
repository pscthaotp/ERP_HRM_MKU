...
namespace ERP.Module.Report.BepAn
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Bếp ăn - Đề nghị mua hàng")]
    public class Report_BepAn_KhoBep_DeNghiMuaHang : StoreProcedureReport
    {
        ...
        public Report_BepAn_KhoBep_DeNghiMuaHang(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_KhoBep_DeNghiMuaHang", System.Data.CommandType.StoredProcedure, parameter);
