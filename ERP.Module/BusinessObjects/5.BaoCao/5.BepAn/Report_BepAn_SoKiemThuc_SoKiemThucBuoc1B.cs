...
namespace ERP.Module.Report.BepAn
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Bếp ăn - Sổ kiểm thực - Sổ kiểm thực bước 1B")]
    public class Report_BepAn_SoKiemThuc_SoKiemThucBuoc1B : StoreProcedureReport, ICongTy
    {
        ...
        public Report_BepAn_SoKiemThuc_SoKiemThucBuoc1B(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_BepAn_SoKiemThuc_SoKiemThucBuoc1B", System.Data.CommandType.StoredProcedure, parameter);
