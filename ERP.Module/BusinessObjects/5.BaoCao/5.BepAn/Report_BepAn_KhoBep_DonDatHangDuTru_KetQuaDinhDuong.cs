...
namespace ERP.Module.Report.BepAn
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Bếp ăn - Kết quả dinh dưỡng - Đơn hàng dự trù")]
    [Appearance("Enabled_SoLuong", TargetItems = "SoLuong", Enabled = false, Criteria = "LoaiChotSuatAn <> 0")]
    public class Report_BepAn_KhoBep_DonDatHangDuTru_KetQuaDinhDuong : StoreProcedureReport
    {
        ...
        public Report_BepAn_KhoBep_DonDatHangDuTru_KetQuaDinhDuong(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_KhoBep_DonDatHangDuTru_KetQuaDinhDuong", System.Data.CommandType.StoredProcedure, parameter);
