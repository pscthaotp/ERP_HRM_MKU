...
namespace ERP.Module.Report.BepAn
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Bếp ăn - Kết quả dinh dưỡng tuần - Đề nghị xuất kho")]
    [Appearance("Enabled_SoLuong", TargetItems = "SoLuong", Enabled = false, Criteria = "LoaiChotSuatAn <> 0")]
    public class Report_BepAn_KhoBep_DeNghiXuatKho_KetQuaDinhDuongTuan : StoreProcedureReport
    {
        ...
        public Report_BepAn_KhoBep_DeNghiXuatKho_KetQuaDinhDuongTuan(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            parameter[7] = new SqlParameter("@Bep_DeNghiXuatKho", Bep_DeNghiXuatKho != null ? Bep_DeNghiXuatKho.Oid : Guid.Empty);
            parameter[8] = new SqlParameter("@SecuritySystemUser", Common.SecuritySystemUser_GetCurrentUser().Oid);

            SqlCommand cmd = DataProvider.GetCommand("spd_Report_KhoBep_DeNghiXuatKho_KetQuaDinhDuongTuan", System.Data.CommandType.StoredProcedure, parameter);
