...
namespace ERP.Module.Report.BepAn
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Bếp ăn - Kết quả dinh dưỡng tuần - Đề nghị mua hàng")]
    [Appearance("Enabled_SoLuong", TargetItems = "SoLuong", Enabled = false, Criteria = "LoaiChotSuatAn <> 0")]
    public class Report_BepAn_KhoBep_DeNghiMuaHang_KetQuaDinhDuongTuan : StoreProcedureReport
    {
        private Bep_DeNghiMuaHang _Bep_DeNghiMuaHang;
        ...
        [ModelDefault("Caption", "Đề nghị mua hàng")]
        [ImmediatePostData]
        public Bep_DeNghiMuaHang Bep_DeNghiMuaHang
        {
            get
            {
                return _Bep_DeNghiMuaHang;
            }
            set
            {
                SetPropertyValue("Bep_DeNghiMuaHang", ref _Bep_DeNghiMuaHang, value);
            }
        }
        ...
        public Report_BepAn_KhoBep_DeNghiMuaHang_KetQuaDinhDuongTuan(Session session) : base(session) { }
        ...
        public override void AfterConstruction()
        {
            ...
            LoaiChotSuatAn = LoaiChotSuatAnTuChonEnum.Mua;
        }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            parameter[7] = new SqlParameter("@Bep_DeNghiMuaHang", Bep_DeNghiMuaHang != null ? Bep_DeNghiMuaHang.Oid : Guid.Empty);
            parameter[8] = new SqlParameter("@SecuritySystemUser", Common.SecuritySystemUser_GetCurrentUser().Oid);

            SqlCommand cmd = DataProvider.GetCommand("spd_Report_KhoBep_DeNghiMuaHang_KetQuaDinhDuongTuan", System.Data.CommandType.StoredProcedure, parameter);
