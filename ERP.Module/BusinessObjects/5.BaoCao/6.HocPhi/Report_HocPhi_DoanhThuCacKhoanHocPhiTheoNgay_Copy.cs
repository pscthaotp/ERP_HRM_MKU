...
namespace ERP.Module.Report.HocPhi
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "TP20. Doanh thu các khoản thu học phí (Theo ngày) - Học phí")]
    public class Report_HocPhi_DoanhThuCacKhoanHocPhiTheoNgay_Copy : StoreProcedureReport, ICongTy
    {
        // Fields...
        ...
        public Report_HocPhi_DoanhThuCacKhoanHocPhiTheoNgay_Copy(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_HocPhi_DoanhThuCacKhoanHocPhiTheoNgay", System.Data.CommandType.StoredProcedure, parameter);
