...
namespace ERP.Module.Report.HocPhi
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Danh sách học sinh chưa đóng phí - Học phí")]
    public class Report_HocPhi_DanhSachHocSinhChuaDongPhi : StoreProcedureReport, ICongTy
    {
        ...
        public Report_HocPhi_DanhSachHocSinhChuaDongPhi(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            parameter[3] = new SqlParameter("@HeDaoTao", HeDaoTao != null ? HeDaoTao.Oid : Guid.Empty);
            //SqlCommand cmd = DataProvider.GetCommand("spd_Report_HocPhi_DanhSachHSChuaDongPhi", System.Data.CommandType.StoredProcedure, parameter);
