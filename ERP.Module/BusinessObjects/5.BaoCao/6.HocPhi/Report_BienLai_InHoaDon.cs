...
namespace ERP.Module.Report.HocPhi
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "In hóa đơn học phí - Học phí")]
    public class Report_BienLai_InHoaDon : StoreProcedureReport, ICongTy
    {
        // Fields...
        ...
        private void Update_rptBLList()
        {
            ...
            {
                using (DialogUtil.AutoWait("Đang lấy danh sách hóa đơn!"))
                {
                    ...
                    if (dt != null)
                    {
                        foreach (DataRow r in dt.Rows)
                        {
                            ...
                            item.NgayLap = Convert.ToDateTime(r["NgayLap"].ToString());
        ...
        #endregion
        public Report_BienLai_InHoaDon(Session session) : base(session) { }

        
        public override void AfterConstruction()
        {
            base.AfterConstruction();
            ReportBienLaiList = new XPCollection<Report_BienLai>(Session, false);
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            parameter[2] = new SqlParameter("@LoaiChungTu_In", LoaiChungTuEnum.HoaDon);
