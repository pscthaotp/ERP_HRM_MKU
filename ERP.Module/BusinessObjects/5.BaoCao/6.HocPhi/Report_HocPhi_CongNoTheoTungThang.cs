...
namespace ERP.Module.Report.HocPhi
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Công nợ theo từng tháng - Học phí")]
    public class Report_HocPhi_CongNoTheoTungThang : StoreProcedureReport, ICongTy
    {
        // Fields...
        ...
        public Report_HocPhi_CongNoTheoTungThang(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Report_HocPhi_CongNoTheoTungThang", System.Data.CommandType.StoredProcedure, parameter);
