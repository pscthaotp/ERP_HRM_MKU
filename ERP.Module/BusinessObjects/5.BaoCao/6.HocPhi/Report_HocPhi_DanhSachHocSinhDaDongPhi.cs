...
namespace ERP.Module.Report.HocPhi
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Danh sách học sinh đã đóng phí - Học phí")]
    public class Report_HocPhi_DanhSachHocSinhDaDongPhi : StoreProcedureReport, ICongTy
    {
        // Fields...
        ...
        public Report_HocPhi_DanhSachHocSinhDaDongPhi(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //SqlCommand cmd = DataProvider.GetCommand("spd_Report_HocPhi_DanhSachHSDaDongPhi", System.Data.CommandType.StoredProcedure, parameter);
