...
namespace ERP.Module.Report.HocPhi
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Doanh thu các khoản học phí (Theo ngày) - Học phí")]
    public class Report_HocPhi_DoanhThuCacKhoanHocPhiTheoNgay : StoreProcedureReport, ICongTy
    {
        // Fields...
        ...
        public Report_HocPhi_DoanhThuCacKhoanHocPhiTheoNgay(Session session) : base(session) { }
