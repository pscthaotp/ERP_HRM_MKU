...
{
    [NonPersistent]
    [ModelDefault("Caption", "Xuất nhập tồn giáo dục - Kho")]
    public class Report_Kho_XuatNhapTonGiaoDuc : StoreProcedureReport
    {
        ...
        public Report_Kho_XuatNhapTonGiaoDuc(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            HHList.Criteria = new InOperator("Oid", Common.Get_HangHoa_ByHangHoaCha(Session, LoaiPhanHeEnum.GiaoDuc));
            ...
            //
            SqlCommand cmd = DataProvider.GetCommand("spd_Rpt_Kho_XuatNhapTonGiaoDuc", CommandType.StoredProcedure, param);
            //
            return cmd;
        }
    }
