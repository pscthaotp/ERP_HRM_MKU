...
{
    [NonPersistent]
    [ModelDefault("Caption", "Danh sách học sinh ra trường - Tuyển sinh")]
    [Appearance("DanhSachHoSoBaoLuu.TatCaTruong", TargetItems = "CongTy", Enabled = false, Criteria = "TatCa")]
    public class BaoCao_TuyenSinh_DanhSachHocSinhRaTruong : StoreProcedureReport, ICongTy
    {
        //
        ...
        public BaoCao_TuyenSinh_DanhSachHocSinhRaTruong(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = DataProvider.GetCommand("spd_Rpt_TuyenSinh_DanhSachHocSinhRaTruong", CommandType.StoredProcedure, param);
            //
            return cmd;
        }
    }
