...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo khiếu nại khách hàng")]
    [Appearance("KhieuNaiKhachHang.TatCaTruong", TargetItems = "CongTy", Enabled = false, Criteria = "TatCa")]
    public class BaoCao_TuyenSinh_KhieuNaiKhachHang : StoreProcedureReport, ICongTy
    {
        //
        ...
        public BaoCao_TuyenSinh_KhieuNaiKhachHang(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = DataProvider.GetCommand("spd_Rpt_TuyenSinh_KhieuNaiKhachHang", CommandType.StoredProcedure, param);
            //
            return cmd;
        }
    }
