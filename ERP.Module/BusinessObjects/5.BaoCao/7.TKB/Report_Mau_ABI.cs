...
namespace ERP.Module.Report.ThoiKhoaBieu
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Mẫu chương trình abi+")]
    public class Report_Mau_ABI : StoreProcedureReport
    {
        ...
        public Report_Mau_ABI(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            parameter[4] = new SqlParameter("@LoaiKhoa", 2);
