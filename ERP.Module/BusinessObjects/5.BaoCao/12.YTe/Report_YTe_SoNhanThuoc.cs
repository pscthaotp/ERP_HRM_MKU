...
namespace ERP.Module.Report.YTe
{
    [NonPersistent()]
    [ImageName("BO_Report")]
    [ModelDefault("Caption", "Sổ nhận thuốc - Y tế")]
    public class Report_YTe_SoNhanThuoc : StoreProcedureReport, ILop
    {
        // Fields...
        ...
        public Report_YTe_SoNhanThuoc(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = DataProvider.GetCommand("spd_Rpt_YTe_SoNhanThuoc", System.Data.CommandType.StoredProcedure, parameter);
            return cmd;
        }
    }
