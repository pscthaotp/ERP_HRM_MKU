...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo nhân sự nghỉ việc - Nhân sự")]
    [Appearance("BaoCao_DanhSach_NhanSuNghiViec.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class BaoCao_DanhSach_NhanSuNghiViec : StoreProcedureReport
    {
        ...
        public BaoCao_DanhSach_NhanSuNghiViec(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Rpt_DanhSach_NhanSuNghiViec");
