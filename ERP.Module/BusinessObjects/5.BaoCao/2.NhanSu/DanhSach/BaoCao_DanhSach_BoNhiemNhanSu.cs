...
{
    [NonPersistent]
    [ModelDefault("Caption", "Báo cáo bổ nhiệm nhân sự - Nhân sự")]
    [Appearance("BaoCao_DanhSach_BoNhiemNhanSu.TatCaDonVi", TargetItems = "BoPhan", Enabled = false, Criteria = "TatCaDonVi")]
    public class BaoCao_DanhSach_BoNhiemNhanSu : StoreProcedureReport
    {
        ...
        public BaoCao_DanhSach_BoNhiemNhanSu(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand("spd_Rpt_DanhSach_BoNhiemNhanSu");
