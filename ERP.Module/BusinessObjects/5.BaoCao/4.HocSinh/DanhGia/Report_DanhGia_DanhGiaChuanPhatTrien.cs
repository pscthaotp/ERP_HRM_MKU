...
{
    [NonPersistent]
    [ModelDefault("Caption", "Đánh giá chuẩn phát triển - Học sinh")]
    public class Report_DanhGia_DanhGiaChuanPhatTrien : StoreProcedureReport,ILop
    {
        //
        private Lop _Lop;
        ...
        public Report_DanhGia_DanhGiaChuanPhatTrien(Session session) : base(session) { }
        ...
        public override SqlCommand CreateCommand()
        {
            ...
            //
            SqlCommand cmd = DataProvider.GetCommand("spd_Rpt_DanhGia_DanhGiaChuanPhatTrien", CommandType.StoredProcedure, param);
            //
            return cmd;
        }
    }
