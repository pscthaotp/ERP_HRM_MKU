...
namespace ERP.Module.Commons
{
    public static class FptProvider
    {
        ...
        /// </summary>
        public static string GetFileName_Next(string tenLoaiGiayTo, Guid maLoaiGiayTo)
        {
            ...
            try
            {
                object obj = DataProvider.GetValueFromDatabase("spd_PapersRecords_PapersNumberMax", CommandType.StoredProcedure, param);
                ...
                fileName_Next = string.Format("{0}_{1}", tenLoaiGiayTo, soThuTuLonNhat + 1);
            }
            catch (Exception ex)
            {
