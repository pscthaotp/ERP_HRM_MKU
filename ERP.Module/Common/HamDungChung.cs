...
namespace ERP.Module.Commons
{
    public static class HamDungChung
    {
        ...
        private static string Donvi(string so)
        {
            ...
            if (so.Equals("1")) Kdonvi = "";
            if (so.Equals("2")) Kdonvi = "nghìn";
            if (so.Equals("3")) Kdonvi = "triệu";
            if (so.Equals("4")) Kdonvi = "tỷ";
            if (so.Equals("5")) Kdonvi = "nghìn tỷ";
            if (so.Equals("6")) Kdonvi = "triệu tỷ";
            if (so.Equals("7")) Kdonvi = "tỷ tỷ";
            return Kdonvi;
        }
        ...
        public static string Convert_Number_To_String(double gNum)
        {
            if (gNum == 0)
                return "Không đồng";
